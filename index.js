    ...
    var results = _.chain(data.movies)
        .filter(function (movie) {
            ...
            return {
                ...
                torrents: _.reduce(movie.torrents.reverse(), function (torrents, torrent) {
                    if (torrent.quality !== '3D') {
                        torrents[torrent.quality] = {
                            url: torrent.url,
                            magnet: 'magnet:?xt=urn:btih:' + torrent.hash + '&tr=udp://glotorrents.pw:6969/announce&tr=udp://tracker.opentrackr.org:1337/announce&tr=udp://torrent.gresille.org:80/announce&tr=udp://tracker.openbittorrent.com:80&tr=udp://tracker.coppersurfer.tk:6969/announce&tr=udp://tracker.leechers-paradise.org:6969/announce&tr=udp://p4p.arenabg.ch:1337&tr=udp://tracker.internetwarriors.net:1337&tr=udp://9.rarbg.com:2790/announce&tr=udp://p4p.arenabg.com:1337',
